...
registerOnClick('oColor01', false, false, [0,1,2], function() {
  assignMat('TShirt', 'mColor1');
}, function() {});

registerOnClick('oColor02', false, false, [0,1,2], function() {
  assignMat('TShirt', 'mColor2');
}, function() {});

registerOnClick('oColor03', false, false, [0,1,2], function() {
  assignMat('TShirt', 'mColor3');
}, function() {});

registerOnClick('oEstampa01', false, false, [0,1,2], function() {
  assignMat('oEstampa00', 'mEstampa01');
}, function() {});

registerOnClick('oEstampa02', false, false, [0,1,2], function() {
  assignMat('oEstampa00', 'mEstampa02');
}, function() {});

registerOnClick('oEstampa03', false, false, [0,1,2], function() {
  assignMat('oEstampa00', 'mEstampa03');
}, function() {});
